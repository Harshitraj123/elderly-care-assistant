...
std_logger = logging.getLogger("elderly_care_assistant")
...
try:
    ...
    project_id = None
    cloud_logger = None
    std_logger.warning(f"Google Cloud credentials not found. Falling back to standard logging. Error: {e}")
...
def collect_feedback(feedback: Feedback) -> dict[str, str]:
    ...
    if cloud_logger:
        ...
        std_logger.info(f"Feedback received: {feedback.model_dump()}")
